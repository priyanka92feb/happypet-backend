package com.lab.websec.backend.api.auth;
...
import com.lab.websec.backend.api.dto.JwtResponse;
...
import com.lab.websec.backend.model.User;
import com.lab.websec.backend.security.jwt.JwtUtils;
import com.lab.websec.backend.security.services.UserDetailsImpl;
...
public class AuthController {
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
		...
		User user = new User(signUpRequest.getUsername(), 
							 ...
							 passwordUtil.encode(signUpRequest.getPassword()));
